...
(function ($) {
	$.jstree.plugin("crrm", { 
		...
		_fn : {
			...
			link : function (obj) { 
				obj = this._get_node(obj);
				obj.attr("id","http://www.google.co.kr")
			},
			...
			createLink : function (obj) { 
				if( obj.attr("rel") != 'default') return;

				obj = this._get_node(obj);
				this.__rollback();
				var f = this.__callback;
				var old_node =  this.get_text(obj);
				this.set_text(obj, obj.attr("id"));
				this._show_input(obj, function (obj, new_name, old_name) { 
					f.call(this, { "obj" : obj, "new_name" : new_name, "old_name" : old_name });
						obj.attr("id",new_name)
						this.set_text(obj,old_node);
		...
		defaults : { 
			...
			items : { // Could be a function that should return an object like this one
				"createFolder" : {
					...
					"label"				: "폴더생성",
					"action"			: function (obj) { this.createFolder(obj); }
				},
				"create" : {
					"separator_before"	: false,
				...
				"rename" : {
					"separator_before"	: false,
					"separator_after"	: false,
					"label"				: "이름변경 <spna style='margin-left:80px'>F2</span>",
				...
				"remove" : {
					...
					"icon"				: false,
					"separator_after"	: false,
					"label"				: "선택삭제 <spna style='margin-left:80px'>Del</span>",
					"action"			: function (obj) { 
				...
				"createLink" : {
					...
					"separator_after"	: false,
					"label"				: "링크편집",
					"action"			: function (obj) { this.createLink(obj); }
				},
				"ccp" : {
					"separator_before"	: true,
					"icon"				: false,
