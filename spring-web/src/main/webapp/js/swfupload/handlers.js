...
//------------------------------------- 파일폼 템플릿
var fileTemplate = ""
+ "<div style='float:left;margin-bottom:5px'><button  id='fmBtn1' onClick='closeUploadModal()' onfocus='blur()'>닫기</button></div>"
+ "<div style='float:left;margin-left:5px;margin-bottom:5px' id='fileDelete'><button id='fmBtn2' onClick='removeFile()' onfocus='blur()'>삭제</button></div>"
+ "<div style='float:left;margin-left:5px;margin-bottom:5px' id='fileSend'><button  id='fmBtn3'' onClick='swfu.startUpload()' onfocus='blur()'>전송</button></div>"
